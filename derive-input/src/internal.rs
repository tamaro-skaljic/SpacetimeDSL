...
pub(crate) fn try_parse(
    ...
    let (table_args, column_args) = integration::spacetime_bindings_macro_input(input, &plural_name)?;
...
fn parse_plural_name_from_args(args: &proc_macro2::TokenStream) -> syn::Result<syn::Ident> {
    ...
    plural_name_value.ok_or_else(|| syn::Error::new(
