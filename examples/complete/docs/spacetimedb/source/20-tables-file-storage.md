...
Store binary data using `Vec<u8>`. This approach keeps data within the database, ensuring it participates in transactions and real-time updates.
...
- **Data clients need** (real-time avatar updates)
