...
When you need to store something, you define a table. When you need to query something, you query a table. When you need to update something, you update a table. When you want to restrict who can read data, you create [a table](/docs/functions/views).
...
SpacetimeDB doesn't limit you to declarative rules or configuration files. Your module is real code (Rust) running inside the database. You have the full power of a procedural, normal programming language at your disposal.
